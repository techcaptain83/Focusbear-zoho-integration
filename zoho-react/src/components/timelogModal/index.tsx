...
const TimelogModal = ({
  ...
  const handleAddTimeLog = async (e: any) => {
    ...
    try {
      ...
      console.log("🚀 ~ file: index.tsx:60 ~ handleCallback ~ error:", error);
      setShowModal(false);
          ...
          <div className="p-6 space-y-6">
            <form onSubmit={handleAddTimeLog}>
              <div className="flex flex-col items-start mb-3">
                <label
                  htmlFor="date"
                  className="label p-0 mb-[0.5rem] dark:text-slate-400"
                >
              ...
              <div className="flex flex-col items-start mb-3">
                <label
                  ...
                  className="label p-0 mb-[0.5rem] dark:text-slate-400"
                >
                  Task:<span className="text-sm text-red-500">*</span>
                </label>
                <input
                  type="text"
                  id="name"
              ...
              <div className="flex flex-col items-start mb-3">
                <label
                  ...
                  className="label p-0 mb-[0.5rem] dark:text-slate-400"
                >
                  Time:<span className="text-sm text-red-500">*</span>
                </label>
                <input
                  type="text"
                  id="hours"
                  ...
                  onChange={OnFormInputChange}
                  className="rounded-lg h-[30px] w-full py-5 px-5 dark:bg-slate-800/60 dark:border-slate-700/50 focus:outline-none"
                  placeholder="Enter Your Timelog"
                />
                <span className="mt-2 text-sm text-red-500 dark:text-red-400">
                  {errors?.hours}
                </span>
              ...
              <div className="flex flex-col items-start mb-3">
                <label
                  ...
                  className="label p-0 mb-[0.5rem] dark:text-slate-400"
                >
                  Bill Status:<span className="text-sm text-red-500">*</span>
                </label>
                <select
                  name="bill_status"
                  ...
                  onChange={OnFormInputChange}
                  id="bill_status"
                  className="rounded-lg h-[40px] w-full py-2 px-5 dark:bg-slate-800/60 dark:border-slate-700/50 focus:outline-none"
                >
